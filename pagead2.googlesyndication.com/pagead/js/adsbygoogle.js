(function(sttc) {
    ...
    */
    ...
    const Jb = /^-?([1-9][0-9]*|0)(\.[0-9]+)?$/;

    function Kb(a) {
        const b = typeof a;
        return b === "number" ? Number.isFinite(a) : b !== "string" ? !1 : Jb.test(a)
    }

    function w(a) {
        if (a != null) {
            if (!Number.isFinite(a)) throw Hb("enum");
            a |= 0
        }
        return a
    }
    ...
    function Mb(a) {
        if (typeof a !== "number") throw Hb("int32");
    ...
    function Tb(a) {
        ...
        Qb(a) || (a.length < 16 ? fb(Number(a)) : (a = BigInt(a), cb = Number(a & BigInt(4294967295)) >>> 0, db = Number(a >> BigInt(32) & BigInt(4294967295))), a = hb());
        return a
    }
    ...
    function ec(a, b, c, d, e) {
        if (a != null) {
            if (Array.isArray(a)) a = vb(a, void 0, 0) ? void 0 : e && (a[t] | 0) & 2 ? a : fc(a, b, c, d !== void 0, e);
            else if (ub(a)) {
                const f = {};
    ...
    function fc(a, b, c, d, e) {
        ...
        d = d ? !!(f & 32) : void 0;
        a = jb(a);
        for (let g = 0; g < a.length; g++) a[g] = ec(a[g], b, c, d, e);
        c && c(f, a);
        return a
    }
    ...
    function hc(a) {
        return a.qa === rb ? a.toJSON() : cc(a)
    }
    var ic = typeof structuredClone != "undefined" ? structuredClone : a => fc(a, gc, void 0, void 0, !1);

    function jc(a, b, c = qb) {
        if (a != null) {
            ...
            if (Array.isArray(a)) {
                ...
                return b ? (a[t] = (d | 34) & -12293, a) : fc(a, jc, d & 4 ? qb : c, !0, !0)
            }
            a.qa === rb && (c = a.D, d = c[t], a = d & 2 ? a : ac(a.constructor, kc(c, d, !0)));
            return a
        }
    }
    ...
    function lc(a) {
        const b = a.D,
            c = b[t];
        return c & 2 ? ac(a.constructor, kc(b, c, !1)) : a
    };
    ...
    function pc(a, b) {
        (nc || (nc = new WeakMap)).set(a, b);
        (qc || (qc = new WeakMap)).set(b, a)
    };

    function rc(a, b, c, d) {
        if (!(4 & b)) return !0;
        if (c == null) return !1;
        !d && c === 0 && (4096 & b || 8192 & b) && (a.constructor[mb] = (a.constructor[mb] | 0) + 1) < 5 && Gb();
        return c === 0 ? !1 : !(c & b)
    }
    ...
    function tc(a, b, c, d) {
        ...
        if (c >= e) {
            ...
            var f = a.length;
            return d && b & 256 && (d = a[f - 1][c], d != null) ? (uc(a, b, e, c) && lb != null && (a = Cb ? ? (Cb = {}), b = a[lb] || 0, b >= 4 || (a[lb] = b + 1, Gb())), d) : uc(a, b, e, c)
        }
    }
    ...
    function xc(a, b, c, d) {
        ...
        var h = d[t] | 0;
        if (rc(a, h, void 0, !1)) {
            if (4 & h || Object.isFrozen(d)) d = jb(d), h = zc(h, f), f = z(e, f, b, d);
            let l = a = 0;
            for (; a < d.length; a++) {
                const m = c(d[a]);
                m != null && (d[l++] = m)
        ...
        let k;
        g === 1 || g === 4 && 32 & h ? Bc(h) || (f = h, h |= 2, h !== f && (d[t] = h), Object.freeze(d)) : (c = g !== 5 ? !1 : !!(32 & h) || Bc(h) || !!nc ? .get(d), (g === 2 || c) && Bc(h) && (d = jb(d), h = zc(h, f), h = Cc(h, f, !1), d[t] = h, f = z(e, f, b, d)),
            Bc(h) || (b = h, h = Cc(h, f, !1), h !== b && (d[t] = h)), c && (k = mc(d)));
        return k || d
    }
    ...
    function Dc(a, b, c, d) {
        ...
        const l = !k && (void 0 === Ab || !1);
        if (rc(a, g))
            for (g = 21, k && (c = jb(c), h = 0, g = zc(g, f), g = Cc(g, f, !0)), k = 0; k < c.length; k++) c[k] = d(c[k]);
        l && (c = jb(c), h = 0, g = zc(g, f), g = Cc(g, f, !0));
        g !== h && (c[t] = g);
        z(e, f, b, c);
        return a
    }
    ...
    function Ec(a, b) {
        ...
        d = !!(4 & d) && !!(4096 & d);
        if (Array.isArray(b))
            for (var h = 0; h < b.length; h++) c.push(Ub(b[h], d));
        else
            for (h of b) c.push(Ub(h, d))
    }
    ...
    function Hc(a, b, c, d) {
        ...
        for (let f = 0; f < d.length; f++) {
            const g = d[f];
            tc(b, c, g) != null && (e !== 0 && (c = z(b, c, e)), e = g)
        }
        a.set(d, e);
        return e
    }
    ...
    function E(a, b, c, d) {
        ...
        if (g && !(8 & k || !d.length && (f === 1 || f === 4 && 32 & k))) {
            Bc(k) && (d = jb(d), k = zc(k, a), a = z(e, a, c, d));
            b = d;
            g = k;
            for (l = 0; l < b.length; l++) k = b[l], m = lc(k), k !== m && (b[l] = m);
            g |= 8;
            g = b.length ? g & -17 : g | 16;
            k = b[t] = g
        }
        let n;
        f === 1 || f === 4 && 32 & k ? Bc(k) || (c = k, k |= !d.length || 16 & k && (!h || 32 & k) ? 2 : 2048, k !== c && (d[t] = k), Object.freeze(d)) : (h = f !== 5 ? !1 : !!(32 & k) || Bc(k) || !!nc ? .get(d), (f === 2 || h) && Bc(k) && (d = jb(d), k = zc(k, a), k = Cc(k, a, !1), d[t] = k, a = z(e, a, c, d)), Bc(k) || (c = k, k = Cc(k, a, !1), k !== c && (d[t] = k)), h && (n = mc(d)));
        return n || d
    }
    ...
    function Pc(a, b, c) {
        ...
        if (l || k && f !== g) c = jb(c), g = 0, f = zc(f, e), f = Cc(f, e, !0);
        f !== g && (c[t] = f);
        z(d, e, b, c);
        return a
    }
    ...
    function Qc(a, b) {
        a = sc(a, b);
        var c;
        a == null ? c = a : Kb(a) ? typeof a === "number" ? c = Rb(a) : c = Tb(a) : c = void 0;
        return c
    }
    ...
    function K(a, b, c) {
        if (c != null) {
            var d = !!d;
            if (!Kb(c)) throw Hb("int64");
            c = typeof c === "string" ? Tb(c) : d ? Sb(c) : Rb(c)
        }
        return B(a, b, c, "0")
    }
    ...
    function ed(a) {
        var b = dd ? a.D : fc(a.D, hc, void 0, void 0, !1);
        var c = !dd;
    ...
    */
    ...
    function Kd() {
        return Aa && Fa ? Fa.mobile : !Ld() && (r("iPod") || r("iPhone") || r("Android") || r("IEMobile"))
    }
    ...
    var he = () => {
        ...
        ke = a => {
            var b = je;
            b.readyState === "complete" || b.readyState === "interactive" ? (ce.push(a), ce.length == 1 && (window.Promise ? Promise.resolve().then(de) : window.setImmediate ? setImmediate(de) : setTimeout(de, 0))) : b.addEventListener("DOMContentLoaded", a)
        };
    ...
    var Ze = class {
        ...
        T(a, b, c, d, e) {
            ...
            try {
                ...
                for (let ib = 0, Eg = k.length - 1; ib <= Eg; ++ib) k[ib].depth =
                    Eg - ib;
                l = p;
    ...
    var tf = class {
        constructor(a, b) {
            ...
            a = b.D;
            c = a[t];
            this.j = c & 2 ? b : ac(b.constructor, kc(a, c, !0))
        }
    };
    ...
    function gg(a, ...b) {
        try {
            a.F && rf(a.g.concat(b), a.j).length >= 65536 && lg(a), a.u && !a.A && (a.A = !0, mg(a.u, () => {
                lg(a)
            })), a.g.push(...b), a.g.length >= a.C && lg(a), a.g.length && a.i === null && (a.i = setTimeout(() => {
                lg(a)
            }, a.J))
        } catch (c) {
            sf(c, a.j)
    ...
    function sg(a, b, c, d, e) {
        if (a.j) {
            ...
            c = y(b, 2, w(c));
            d = y(c, 3, Nb(d));
            if (e.ga === void 0) Fc(d, 4, hf, w(e.O));
            else switch (e.ga) {
                case 3:
                    c = new bf;
                    c = Fc(c, 2, cf, w(e.property));
                    e = y(c, 1, w(e.O));
                    Oc(d, 5, hf, e);
                    break;
                case 4:
                    c = new bf;
                    c = Fc(c, 3, cf, w(e.property));
                    e = y(c, 1, w(e.O));
                    Oc(d, 5, hf, e);
                    break;
                case 5:
                    c = new bf, c = Fc(c, 4, cf, w(e.property)), e = y(c, 1, w(e.O)), Oc(d, 5, hf, e)
            }
            e = new Yf;
            e = Oc(e, 9, Zf, d);
            hg(a.i, pg(a, e))
        ...
        for (const n of b) {
            ...
            for (const q of a) {
                ...
                if (v) {
                    ...
                    k && N(Ag).j[n] ? .has(v) && f.push(k);h === 8 && b[v] ? (k = of (JSON.stringify(b[v])), h = Kc(q, Mc, 4), k = Yc(Lc(k), 4, A()), Ec(h, k)) :
                    k && N(Ag).g.get(n) ? .has(v) && g.push(k);e || (h = v, k = n, l = d, m = N(Ag), m.g.has(k) || m.g.set(k, new Map), m.g.get(k).has(h) || m.g.get(k).set(h, []), l && m.g.get(k).get(h).push(l));b[v] = ed(q)
                }
            }
        }
        if (f.length || g.length) a = d ? ? void 0, c.j && c.u && (d = new Wf, f = Pc(d, 2, f), g = Pc(f, 3, g), a && B(g, 1, Nb(a), 0), f = new Yf, g = Oc(f, 7, Zf, g), hg(c.i, pg(c, g)))
    }
    ...
    function Ye(a, b, c, d = !1, e) {
        if ((d ? a.g : Math.random()) < (e || .01)) try {
            let f;
            c instanceof We ? f = c : (f = new We, Vd(c, (h, k) => {
                var l = f;
                const m = l.u++;
                h = Re(k, h);
                l.g.push(m);
    ...
    const uh = a => {
        ...
        vh = a => {
            ...
            Uc(a, 2) != null && (b.o = Uc(a, 2));
            Uc(a, 5) != null && (b.p = Uc(a, 5));
            return b
        };
    ...
    function Ui(a, b, c, d) {
        ...
        e !== !0 ? a = e : d.google_full_width_responsive === "true" || Oi(c, b) ? (b = U(b), a = b - a, a = b && a >= 0 ? !0 : b ? a < -10 ? 11 : a < 0 ? 14 : 12 : 10) : a = 9;
        return a
    }
    ...
    var $i = (a, b, c) => {
        ...
        gj = (a, b) => {
            ...
            c = Infinity;
            do(d = b.style &&
                $d(b.style.height)) && (c = Math.min(c, d)), (d = $i(b, a, "maxHeight")) && (c = Math.min(c, d)); while (b.parentElement && (b = b.parentElement) && b.tagName !== "HTML");
            return c
        };
    const dj = (a, b) => {
        const c = ye(a) === 0;
    ...
    class Fj {
        ...
        T(a, b, c = .01, d, e = "jserror") {
            ...
            p.error_rep_loaded || (Rd(p.document, this.C), p.error_rep_loaded = !0);
            return !1
        }
        ha(a, b, c) {
            try {
    ...
    function Kj(a) {
        if (!a) return null;
        var b = F(a, 7);
        if (F(a, 1) || a.getId() || Yc(a, 4, A()).length > 0) {
            var c = F(a, 3),
                d = F(a, 1),
                e = Yc(a, 4, A(zb));
            b = Uc(a, 2);
            ...
            c && (g += "#" + Bj(c));
            if (e)
                for (c = 0; c < e.length; c++) g += "." + Bj(e[c]);
            b = (e = g) ? new Ej(e, b, f, a) : null
        } else b = b ? new Ej(b, Uc(a, 2), Uc(a, 5), Lj(G(a, 6))) : null;
        return b
    }
    var Mj = {
        1: 1,
    ...
    function Sj(a, b) {
        ...
        b.forEach(e => {
            ...
            } else $c(e, pj, 2, rj) ? Uj(a, $c(e, pj, 2, rj), c) : $c(e, nj, 3, rj) && Vj(a, $c(e, nj, 3, rj), d)
        });
        return new Wj(c,
            d)
    }
    ...
    const Uj = (a, b, c) => {
            D(b, Dh, 2) ? (b = D(b, Dh, 2), (a = Tj(a, D(b, Q, 1))) && c.set(ma(a), G(b, 2))) : D(b, Q, 1) && (a = Xj(a, D(b, Q, 1))) && a.forEach(d => {
                d = ma(d);
                c.set(d, 1);
                c.set(d, 4);
                c.set(d, 2);
    ...
    var bk = (a, b, c) => W.ha(a, b, c),
        ...
        ek = (a, b, c, d) => (Ce(b) ? b.msg || Xe(b.error) : Xe(b)).indexOf("TagError") === 0 ? ((b instanceof Be ? b.error : b).pbr = !0, !1) : W.T(a, b, c, d);
    var fk = class {
        constructor() {
            this.g = he();
            this.i = 0
    ...
    function sk(a, b) {
        ...
        b: {
            ...
            for (const [gb, Zb] of [
                    ...
                    [h.jc, x],
                    [h.zb, L]
                ]) gb === !1 ? f = f.concat(Zb) : C = C.concat(Zb);h = rk(C);f = rk(f);
            h = h.slice(0);
            for (m of f)
        ...
        for (g = 0; g < c.length; g++) {
            ...
            if (D(h, wh, 4) && e.contains(G(D(h, wh, 4), 1)) && G(h, 8) === 1 && uk(h, d)) {
                m.i++;
                if (l = vk(m, h, l, d)) k = Oj(m.g), k.numAutoAdsPlaced || (k.numAutoAdsPlaced = 0), D(h, Q, 1) && Uc(D(h, Q, 1), 5) != null && (k.numPostPlacementsPlaced ? k.numPostPlacementsPlaced++ :
    ...
    function vk(a, b, c, d) {
        ...
        if (!(f = e == null)) {
            ...
            if (c = !f && !(!c && e == 2 && !ok(d))) c = e == 1 || e == 2 ? d : d.parentNode,
        ...
        f = D(b, Eh, 3);
        c = {};
        f && (c.nb = F(f, 1), c.Xa = F(f, 2), c.ub = !!Sc(f, 3));
        f = D(b, wh, 4) && G(D(b, wh, 4), 2) ? G(D(b, wh, 4), 2) : null;
        f = zh(f);
        g = Uc(b, 12) != null ? Uc(b, 12) : null;
        ...
        a: {
            try {
                ...
                (v = c.Ba) && v.parentNode &&
                    (u = v.parentNode, u.removeChild(v), Ih(u) && (u.style.display = u.getAttribute("data-init-display") || "none"));
                v = !1;
                break a
            }
            v = !0
    ...
    const xk = class {
        constructor(a, b, c, d, e) {
            ...
            this.j = c;
            this.A = e || null;
            (this.I = d) ? (a = a.document, d = E(d, qj, 5, A(zb)), d = Sj(a, d)) : d = Sj(a.document, []);
            this.C = d;
            this.F = new lk;
            this.i = 0;
            this.u = !1
    ...
    function uk(a, b) {
        return a && vc(a, wh, 4) && b[G(D(a, wh, 4), 2)] ? !1 : !0
    };
    ...
    class Sk extends Lk {
        ...
        F() {
            this.C = {};
            this.u && (rd(this.j, "message", this.u), delete this.u);
            delete this.C;
            delete this.j;
            delete this.g;
            super.F()
        ...
        addEventListener(a) {
            ...
            const e = (f, g) => {
                clearTimeout(d);
                f ? (b = f, b.internalErrorState = Nk(b),
    ...
    function Yk({
        ...
        if (d = !d) d = new Sk(a), d = typeof d.j.__tcfapi === "function" || Pk(d) != null;
        if (!d) {
            if (c = !c) {
                if (b) {
                    a = zk(a);
    ...
    function sl(a) {
        var b = Number;
        var c = sc(a, 1);
        c = c == null ? c : Kb(c) ? typeof c === "string" ? Tb(c) : Sb(c) : void 0;
        b = b(c ? ? "0");
        a = Vc(a, 2);
    ...
    function wl(a) {
        const b = tl(a, 16);
        return !!tl(a, 1) === !0 ? (a = ul(a), a.forEach(c => {
    ...
    var zl = a => {
        try {
            ...
            b.publisherCC = String.fromCharCode(nl + tl(c, 6)) + String.fromCharCode(nl +
                tl(c, 6));
            b.vendor = {
    ...
    function Sl(a, b, c) {
        ...
        function h(n) {
            const q = [];
            let v = 0;
            for (let u = 0; u < n.length / 2; u++) q.push(jl(n.slice(v, v + 2))), v += 2;
            return q
        }
    ...
    function Ul() {
        var a = S(Sh);
        O !== O.top || O.__uspapi || O.frames.__uspapiLocator || (a = new Vl(a), Wl(a), Xl(a))
    }

    function Wl(a) {
        !a.i || a.l.__uspapi || a.l.frames.__uspapiLocator || (a.l.__uspapiManager = "fc", Tl(a.l, "__uspapiLocator"), sa("__uspapi", (b, c, d) => {
    ...
    function Xl(a) {
        !a.tcString || a.l.__tcfapi || a.l.frames.__tcfapiLocator || (a.l.__tcfapiManager = "fc", Tl(a.l, "__tcfapiLocator"), a.l.__tcfapiEventListeners = a.l.__tcfapiEventListeners || [], sa("__tcfapi", (b, c, d, e) => {
    ...
    function Yl(a, b) {
        ...
        b = E(b, Pl, 2, A()).reduce((f, g) => Wc(Zl(f), 1) > Wc(Zl(g), 1) ? f : g);
        e = xc(e, 3, Ob, A()).indexOf(Vc(b, 1));
        return e === -1 || e >= d.length ? null : {
            uspString: Sl(d[e], Vc(b, 1), a.j),
            Aa: sl(Zl(b))
        }
    }
    ...
    var Vl = class {
        constructor(a) {
            ...
            try {
                ...
                c = null
            }(a = c) ? (c = D(a, Dl, 5) || null, a = E(a, Cl, 7, A()), a = $l(a ? ? []), c = {
                Ya: c,
                ab: a
            }) : c = {
                Ya: null,
    ...
    var rm = class extends M {
        i() {
            return $c(this, im, 13, qm)
        }
        u() {
            return wc(this, im, Ic(this, qm, 13)) !== void 0
        }
        g() {
            return $c(this, jm, 14, qm)
        }
        j() {
            return wc(this, jm, Ic(this, qm, 14)) !== void 0
        }
    };
    rm.B = [19];
    var qm = [13, 14];
    ...
    const Am = [2, 7, 1];
    var Dm = (a, b, c = "", d = null) => b === 1 && Bm(c, d) ? !0 : Cm(a, c, e => Sa(E(e, ld, 2, A()), f => G(f, 1) === b)),
        ...
        Gm = a => {
            const b = Qd(O) || O;
            return Fm(b, a) ? !0 : Cm(O, "", c => Sa(xc(c, 3, Lb, A()), d => d === a))
        };
    ...
    const Lm = a => {
        ...
        Mm = (a, b) => {
            ...
            if (b ? .u()) {
                var c = I(b.i(), 9);
                b = b ? .i() ? .g() ? .i();
                if (!a || c != a || !b) return Am;
                Lm(!1);
                return xc(b, 3, Lb, A(zb))
            }
            if (b ? .j()) {
                c = b ? .g() ? .g();
                if (!c || c.length !== 1 || !a || c[0] !== a || I(b, 17) != p.location.host) return Am;
                a = b ? .g() ? .i() ? .g() ? .i();
                if (!a) return Am;
                Lm(!0);
                return xc(a, 3, Lb, A(zb))
            }
            return Am
        };
    var Nm = (a, b) => {
    ...
    function Vm(a) {
        if (ym(a.l) && !H(a.g, 22)) return lh(Error("invtag"));
        a: {
            var b = a.l;
            var c = a.j;a = a.g;
            if (a ? .u())(b = a ? .i() ? .g() ? .g()) && (E(b, Fh, 1, A()).length > 0 || S(ei) && E(b, Gh, 3, A()).length > 0) ? Km(!1) : b = null;
            else {
                if (a ? .j()) {
                    const d = a ? .g() ? .g(),
                        e = a ? .g() ? .i() ? .g() ? .g();
        ...
        b ? (c = new xj, a = E(b, Fh, 1, A()), c = Pc(c, 1, a), a = E(b, sj, 2, A()), c = Pc(c, 7, a), S(ei) && E(b, Gh, 3, A()).length > 0 && (a =
            new Hh, b = E(b, Gh, 3, A()), b = Pc(a, 1, b), Nc(c, 6, b)), b = jh(c)) : b = lh(Error("invtag"));
        return b
    }
    ...
    var mn = a => {
        ...
        c.aiixl =
            Zm(Gi(ri));
        S(si) && (c.slmct = T(ui), c.samct = T(ni));
        S(pi) || (c.aiict = !0, c.aicel = Zm(Gi(oi)));
        S(vi) && (c.aipaq = !0);
        S(yi) && (c.aigda = !0);
        T(li) && (c.aiapm = T(li));
        T(mi) && (c.aiapmi = T(mi));
    ...
    function on(a) {
        Om(a.l, a.i, a.g.google_ad_client || "", (b, c) => {
            var d = a.l,
                e = a.g;
            X(O).ama_ran_on_page || b && qn(d, e, b, c)
        })
    }
    class pn {
        constructor(a, b) {
    ...
    function qn(a, b, c, d) {
        ...
        vc(c, wj, 24) && (d = Pj(a), d.availableAbg = !0, d.ablationFromStorage = !!D(c, wj, 24) ? .g() ? .g());
        ...
        D(c, wj, 24) ? .g() ? .g() && (Pj(a).ablatingThisPageview = !0, vm(a));
        ue(3, [ed(c)]);
            ...
            if ((b = X(a).head_tag_slot_vars ? .google_ad_client ? ? a.document.querySelector(".adsbygoogle[data-ad-client]") ? .getAttribute("data-ad-client")) == null)
                if (S(Ai)) b = "";
                    ...
                    b: {
                        ...
                        /i(phone|pad|pod)/i.test(a) && /applewebkit/i.test(a) && !/version|safari/i.test(a) && !ze() ? un : vn;
    ...
    Kn.B = [10, 6];
    const Ln = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    ...
    function Mn() {
        ...
        a = a.navigator.userAgentData.getHighEntropyValues(Ln).then(c => {
            b.uach ? ? (b.uach = c);
            return c
        });
    ...
    function Nn(a) {
        return Hn(Gn(En(Bn(In(Dn(Jn(Fn(Cn(new Kn, a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""), a.fullVersionList ? .map(b => {
            var c = new An;
            c = y(c, 1, Vb(b.brand));
    ...
    function Vn(a, b, c) {
        ...
        d = !c.google_ad_slot || c.google_override_format || !yn[c.google_ad_width + "x" + c.google_ad_height] && c.google_loader_used === "aa";
        e = e && d ? e.toLowerCase() : "";
    ...
    function eo(a, b, c, d) {
        b = Math.floor(((a - 8 * b - 8) / b * Zn[d] + $n[d]) * c + 8 * c + 8);
        return a > 1500 ? {
            width: 0,
            height: 0,
    ...
    function fo(a, b) {
        ...
        return {
            width: a,
            height: Math.floor(c / 1.91 + 70) + Math.floor((c * Zn.mobile_banner_image_sidebyside + $n.mobile_banner_image_sidebyside) * b + 8 * b + 8)
        }
    };
    const go = Wa("script");
    class ho {
    ...
    function ko(a, b) {
        lo(a, b);
        if (b.google_content_recommendation_ui_type === "pedestal") return new ho(9, new jo(a, Math.floor(a * b.google_phwr)));
        if (S(Oh)) {
            var c = Kd();
            var d = T(Ph);
            var e = T(Nh),
            ...
            }) : (a = eo(a, 1, d, "image_sidebyside"), d = {
                V: a.width,
                U: a.height,
                K: 1,
                L: d,
                P: "image_sidebyside"
            }) : (d = co(a), e === 1 && (d.height = Math.floor(d.height * .5)), d = {
                V: d.width,
                U: d.height,
                K: f,
                L: e,
        ...
        mo(b, d);
        return new ho(9, new jo(d.V, d.U))
    }
    ...
    function no(a, b) {
        ...
        mo(b, a);
        return new ho(9, new jo(a.V, a.U))
    }
    ...
    function ro(a, b, c, d, e) {
        ...
        if (f === "in-article") {
            ...
            else if (a = Ti(b, c, g, T(Vh), e), a !== !0) e.gfwrnwer = a, a = g;
            else if (a = U(b))
        ...
        return new ho(11,
            f === "in-article" ? new qo(a, b) : new Zi(a, b))
    };
    ...
    function vo(a, b, c, d, e) {
        e.google_full_width_responsive == "false" ? c = {
            G: a,
            H: 1
        } : b === "autorelaxed" && e.google_full_width_responsive || wo(b) || e.google_ad_resize ? (b = Ui(a, c, d, e), c = b !== !0 ? {
            G: a,
            H: b
        } : {
            G: U(c) || a,
    ...
    function xo(a, b, c, d, e) {
        ...
        u = aj(d, c) || "";
        return new ho(h, m, q, null, v, g, n, x, L, l, k, u)
    }
    ...
    function yo(a, b, c, d, e, f) {
        ...
        const {
            ...
            a: if (f) {
                ...
                if (e.google_resizing_allowed || e.google_full_width_responsive == "true") var x = Infinity;
                    ...
                    x = C
                }!(S(Zh) && x <= u * 2) && (x = Math.min(u, x), x < u * .5 || x < 100) && (x = u);
                u = {
                    ca: new oo(a, Math.floor(x)),
                    Z: x < u ? 102 : !0
                }
            } else u = {
                ca: n,
        ...
        return e.google_ad_layout === "in-article" && Bo(c) ? {
            ca: Co(a, c, d, q, e),
            Z: !1,
            ta: b,
            fb: g
    ...
    function Do(a, b, c, d, e) {
        var f;
        (f = U(b)) ? U(b) < 488 ? b.innerHeight >= b.innerWidth ? (e.google_full_width_responsive_allowed = !0, Yi(b, c), f = {
            G: f,
            H: !0
        }) : f = {
            G: a,
        ...
        if (h !== !0 || a === g) return new ho(12, new Zi(a, d), null, null, !0, h, 100);
        const {
            ca: k,
            Z: l,
            ta: m
    ...
    var Fo = (a, b) => {
            ...
            if (c === "link") return 4;
            if (c === "fluid") {
                if (c = b.google_ad_layout === "in-article") c = S(Th) || a.location && (a.location.hash == "#hffwroe2etop" || a.location.hash == "#hffwroe2etoq");
                return c ? (Eo(b), 1) : 8
            }
            if (b.google_reactive_ad_format === 27) return Eo(b), 1
        },
        Ho = (a, b, c, d, e = !1) => {
            var f = b.offsetWidth || (c.google_ad_resize ||
                e) && $i(b, d, "width") || c.google_ad_width || 0;
            a === 4 && (c.google_ad_format = "auto", a = 1);
            e = (e = Go(a, f, b, c, d)) ? e : xo(f, c.google_ad_format, d, b, c);
            e.size().i(d, c, b);
            ...
            f = Qd(window) || window;
            $m(f.location, "google_responsive_dummy_ad") && (Ua([1, 2, 3, 4, 5, 6, 7, 8], e.C) || e.g === 1) && e.g !== 2 && (f = JSON.stringify({
                googMsgType: "adpnt",
                key_value: [{
                    key: "qid",
                    value: "DUMMY_AD"
            ...
            switch (a) {
                case 5:
                    const {
                        G: g,
                        H: h
                    } = bk(247, () => vo(b, d.google_ad_format, e, c, d));
                    h === !0 && b != g && Yi(e, c);
    ...
    function Lo(a, b) {
        if (a.getAttribute("src")) {
            var c = a.getAttribute("src") || "",
                d = Od(c, "client");
            d && (b.google_ad_client = Ko("google_ad_client", d));
            (c = Od(c, "host")) && (b.google_ad_host = Ko("google_ad_host", c))
        }
        a = a.attributes;
        c = a.length;
        for (d = 0; d < c; d++) {
            ...
            if (/data-/.test(e.name)) {
                ...
                b.hasOwnProperty(f) || (e = Ko(f, e.value), e !== null && (b[f] = e))
            }
        }
    }

    function Mo(a) {
        if (a = ve(a)) switch (a.data && a.data.autoFormat) {
            case "rspv":
                return 13;
            case "mcrspv":
                return 15;
    ...
    function No(a, b, c, d) {
        Lo(a, b);
        if (c.document && c.document.body && !Fo(c, b) && !b.google_reactive_ad_format && !b.google_ad_intent_query) {
        ...
        if (S(Rh) ||
            ...
            if (d = $m(f.location, "google_responsive_slot_preview") || S(ii) || Dm(f, 1, e, d)) b: if (b.google_reactive_ad_format || b.google_ad_resize || Fo(c, b) || Qi(a, b)) d = !1;
                else {
                    ...
                    if (!S(bi) && (d = T(Wh), d = Ti(c, a, g, d, b), d !== !0)) {
                        b.gfwrnwer = d;
                        d = !1;
                        break b
                    }
        ...
        if (g = Fo(c, b)) Ho(g, a, b, c, d);
        else {
            if (Qi(a, b)) {
                if (d = Td(a, c)) a.style.width = d.width, a.style.height = d.height, Pi(d, b);
                b.google_ad_width || (b.google_ad_width = a.offsetWidth);
                b.google_ad_height || (b.google_ad_height = a.offsetHeight);
                b.google_loader_features_used = 256;
                b.google_responsive_auto_format = Mo(c)
            } else Pi(a.style, b);
            c.location && c.location.hash === "#gfwmrp" || b.google_responsive_auto_format === 12 && b.google_full_width_responsive === "true" ? Ho(10, a, b, c, !1) : Math.random() < .01 && b.google_responsive_auto_format ===
                12 && (a = Ui(a.offsetWidth || parseInt(a.style.width, 10) || b.google_ad_width, c, a, b), a !== !0 ? (b.efwr = !1, b.gfwrnwer = a) : b.efwr = !0)
        }
    };
    ...
    function Ro(a, b) {
        a.j !== 1 && (a.j = 1, a.g.size > 0 && So(a, b))
    }

    function Po(a) {
        a.l.document.visibilityState ? Qo(a, a.l.document, "visibilitychange", b => {
            a.l.document.visibilityState === "hidden" && Ro(a, b);
            a.l.document.visibilityState === "visible" && (a.j = 0)
        }) : "onpagehide" in a.l ? (Qo(a, a.l, "pagehide", b => {
            Ro(a, b)
        }), Qo(a, a.l, "pageshow", () => {
            a.j = 0
        })) : Qo(a, a.l, "beforeunload", b => {
            Ro(a, b)
        })
    }
    ...
    function Wo(a) {
        const b = a.g.wpc;
        return b !== null && b !== "" ? b : a.g.wpc = xn(a.l)
    }
    ...
    async function cp(a) {
        ...
        if (b.j && !b.g.le.includes(1)) {
            ...
            a = cd(a, 4, b.A);
            d = Oo(b.l);
            d !== 0 && (e = new vf, d = y(e, 1, w(d)), Nc(a, 3, d));
            d = b.i;
            c = Xo(b, c);
            c = Oc(c, 4, Hf, a);
            ig(d, c);
    ...
    var $o = class {
        ...
        get C() {
            return bk(1178, () => fd(Af, ic(this.g.psi || []))) || new Af
        }
        get F() {
            return bk(1227, () => fd(Df, ic(this.g.cc || []))) || new Df
        }
    };
    ...
    function hp(a) {
        var b = O.document;
        if (b.currentScript) return gp(b.currentScript, a);
        for (const c of b.scripts)
            if (gp(c, a) === 0) return 0;
        return 1
    };
    ...
    var op = {
        [3]: {
            ...
            [69]: a => kp(a, p.document),
            [70]: a => lp(a, p.document),
            [79]: a => mp(a,
                p.navigator)
        },
        [4]: {
    ...
    function pp(a, b) {
        ...
        for (const f of b)
            for (const g of E(f, mm, 2, A()))
                if (lm(g).length !== 0) {
                    b = Rc(Pb(sc(g, 8)), 0);
                    J(g, 4) && !J(g, 13) && (b = c.get(J(g, 4)) ? ? 0, d = Rc(Pb(sc(g, 1)), 0) * lm(g).length, c.set(J(g, 4), b + d));
                    d = [];
                    ...
                    qp(a[2], J(g, 10), d) || qp(a[1], J(g, 4), d) || qp(a[0], lm(g)[0].getId(), d)
                }
        return a
    }
    ...
    function tp(a, b) {
        ...
        if (!d.success) return sg(a.M, D(b.ua, df, 3), b.ka, b.R.getId(), d), !1;
        if (!d.value) return !1;
        c = lf(D(b.R, df, 3), c);
        return c.success ? c.value ? !0 : !1 : (sg(a.M, D(b.R, df, 3), b.ka, b.R.getId(), c), !1)
    }
        ...
        for (const n of [0, 1, 2])
            for (const [q, v] of a.oa[n].entries()) {
                var k = q,
                    l = v;
                const u = new Mf;
                var m = l.filter(x => x.ka === b && a.i[x.R.getId()] && tp(a, x));
                if (m.length)
                    for (const x of m) h.push(x.R);
                else if (!a.Ca && (n === 2 ? (m = d[1], Fc(u, 2, Nf, w(k))) : m = d[0], k = m ? .(String(k)) ? ? (n === 2 && J(l[0].ua, 11) === 1 ? void 0 : d[0](String(k))), k !== void 0)) {
                    for (const x of l) {
                        if (x.ka !== b) continue;
                        l =
                            k - x.lb;
                        ...
                        const L = x.ib,
                            C = x.Cb;
                        l < 0 || l >= m * L || l % L !== C || !tp(a, x) || (l = J(x.ua, 13), l !== 0 && l !== void 0 && (m = a.j[String(l)], m !== void 0 && m !== x.R.getId() ? rg(a.M, a.j[String(l)], x.R.getId(), l) : a.j[String(l)] = x.R.getId()), h.push(x.R))
                    }
                    Jc(u, Nf) !== 0 && (B(u, 3, Nb(k), 0), g.push(u))
                }
            }
        for (const n of h) d = n.getId(), e.push(d), up(a, d, f ? 4 : c), Lg(E(n, nf, 2, A()), f ? Ng() : [c], a.M, d);
        qg(a.M, b, c, e, g, 1);
        return e
    }

    function wp(a, b) {
        b = b.map(c => new nm(c)).filter(c => !sp.includes(J(c, 1)));
        a.oa = pp(a.oa, b)
    }
    ...
    function xp(a, b) {
        ...
        P(2, (c, d, e) => vp(a, c, d, e), b);
        P(3, c => (a.g[c] || []).concat(a.g[4]), b);
        P(12, c => void wp(a, c), b);
        P(16, (c, d) => void up(a, c, d), b)
    }
    var yp = class {
        constructor(a, b, c, {
            Ca: d = !1,
    ...
    function Cp({
        ...
        rb: d = jp(),
        sb: e = 0,
        M: f = new tg(D(a, om, 5) ? .g() ? ? 0, D(a, om, 5) ? .i() ? ? 0, D(a, om, 5) ? .j() ? ? !1),
        oa: g = pp({
            [0]: new Map,
            [1]: new Map,
            [2]: new Map
        ...
        d.hasOwnProperty("init-done") ? (Pg(12, d, () => {})(E(a, nm, 2, A()).map(h => ed(h))), Pg(13, d, () => {})(E(a, nf, 1, A()).map(h => ed(h)), e), b && Pg(14, d, () => {})(b), Dp(e, d)) : (xp(new yp(g, e, f, c), d), Qg(d), Rg(d), Sg(d), Dp(e, d), Lg(E(a, nf, 1, A(zb)), [e], f, void 0, !0), vg = vg || !(!c || !c.Ab), Bp(op), b && Bp(b))
    }
    ...
    function Gp(a, b, c) {
        ...
        if (d.plle) Dp(1, jp(a));
            ...
            for (const f of xc(b, 19, Ob, A())) N(Ug).i(f);
            Fp(12, a);
            Fp(10, a);
            a = Qd(a) || a;
            $m(a.location, "google_mc_lab") && N(Ug).i(44738307);
            $m(a.location, "google_auto_storify_swipeable") && N(Ug).i(44773747);
            $m(a.location, "google_auto_storify_scrollable") && N(Ug).i(44773746)
        }
    };
    ...
    function Ip(a) {
        var b = W;
        try {
            return gd(a, $e), new rm(JSON.parse(a))
        } catch (c) {
    ...
    function Kp(a, b, c) {
        b.google_loader_used !== "sd" && (b.abgtt = Jp(a, c))
    };
    var Lp = () => {
        var a = O;
        try {
    ...
    function Qp(a) {
        a = a.id;
        return a != null && (Pp().has(a) || a.startsWith("google_ads_iframe_") || a.startsWith("aswift"))
    }
    ...
    function Rp(a, b, c) {
        ...
        switch (Sp(a)) {
            case 2:
                const d = Tp(a);
                if (d) return c.some(f => Up(d, f));
                break;
            case 1:
                const e = Vp(a);
                if (e) return b.some(f => Up(e, f))
        }
        return !1
    }
    ...
    function Vp(a) {
        return Wp(a, b => b.currentRect)
    }

    function Tp(a) {
        return Wp(a, b => b.previousRect)
    }
    ...
    function Xp() {
        const a = Array.from(document.getElementsByTagName("iframe")).filter(Qp),
            b = [...Pp()].map(c => document.getElementById(c)).filter(c => c !== null);
        Yp = window.scrollX;
        Zp = window.scrollY;
        return $p = [...a, ...b].map(c => c.getBoundingClientRect())
    }
        ...
        if (S(Bl)) {
            ...
            if (!b.google_plmetrics && window.PerformanceObserver) {
                ...
                for (const c of b) b = {
                    type: c,
                    buffered: !0
                }, c === "event" && (b.durationThreshold = 40), cq(a).observe(b);
                dq(a)
            }
        }
    }
    ...
    function eq(a, b) {
        const c = Yp !== window.scrollX || Zp !== window.scrollY ? [] : $p,
            d = Xp();
        for (const e of b.getEntries()) switch (b = e.entryType, b) {
            ...
            case "first-input":
                ...
                a.Ka = !0;
                a.g.some(f => f.entries.some(g => e.duration === g.duration && e.startTime === g.startTime)) || gq(a, e);
                break;
            case "longtask":
    ...
    function dq(a) {
        const b = Ij(641, () => {
                ...
                (d.prerendering ? 3 : {
                    ...
                    preview: 4,
                    unloaded: 5
                }[d.visibilityState || d.webkitVisibilityState || d.mozVisibilityState || ""] || 0) === 2 && hq(a)
            }),
            c = Ij(641, () => void hq(a));
    ...
    function hq(a) {
        if (!a.Qa) {
            ...
            window.LayoutShift && (b += Op("cls", a.F), b += Op("mls", a.X), b += Np("nls", a.va), window.LayoutShiftAttribution && (b += Op("cas", a.A), b += Np("nas", a.Pa), b += Op("was", a.Ua)), b += Op("wls", a.xa), b += Op("tls", a.Ta));
            window.LargestContentfulPaint && (b += Np("lcp", a.Na), b += Np("lcps", a.Ma));
            window.PerformanceEventTiming && a.Ka && (b += Np("fid", a.Ja));
            window.PerformanceLongTaskTiming && (b += Np("cbt", a.C),
                b += Np("mbt", a.J), b += Np("nlt", a.wa));
            let d = 0;
            for (var c of document.getElementsByTagName("iframe")) Qp(c) && d++;
            b += Np("nif", d);
            b += Np("ifi", ye(window));
            c = N(Ug).g();
            b += `&${"eid"}=${encodeURIComponent(c.join())}`;
            b += `&${"top"}=${p===p.top?1:0}`;
            b += a.Sa ? `&${"qqid"}=${encodeURIComponent(a.Sa)}` : Np("pvsid", ie(p));
            window.googletag && (b += "&gpt=1");
            c = Math.min(a.g.length - 1, Math.floor((a.M ? a.La : performance.interactionCount || 0) / 50));
            c >= 0 && (c = a.g[c].latency, c >= 0 && (b += Np("inp", c)));
            window.fetch(b, {
                keepalive: !0,
                credentials: "include",
                redirect: "follow",
    ...
    function fq(a, b, c, d) {
        if (!b.hadRecentInput) {
            ...
            a.va += 1;
            if (c = Rp(b, c, d)) a.A += b.value, a.Pa++;
    ...
    function pq(a, b, c) {
        var d = window;
        d.google_spfd || (d.google_spfd = No);
    ...
    function qq(a, b, c) {
        ...
        if (f && f.Va && b.google_adtest !== "on" && !e) {
            ...
            e = g === 0 ? null : e / g;
            if (!f.ya || f.ya && (e || 0) >= f.ya) return a.className += " adsbygoogle-ablated-ad-slot", c = c.google_sv_map = c.google_sv_map || {}, d = ma(a), b.google_element_uid = d, c[b.google_element_uid] = b, a.setAttribute("google_element_uid", String(d)), f.Jb === "slot" && (Zd(a.getAttribute("width")) !==
                null && a.setAttribute("width", "0"), Zd(a.getAttribute("height")) !== null && a.setAttribute("height", "0"), a.style.width = "0px", a.style.height = "0px"), !0
        }
        if ((f = Td(a, c)) && f.display === "none" && !(b.google_adtest === "on" || b.google_reactive_ad_format > 0 || d)) return c.document.createComment && a.appendChild(c.document.createComment("No ad requested because of display:none on the adsbygoogle tag")), !0;
    ...
    function rq(a) {
        ...
        for (let d = 0, e = b[d]; d < b.length; e = b[++d]) {
            var c = e;
            if (nq(c) && c.dataset.adsbygoogleStatus !== "reserved" && (!a || e.id === a)) return e
        }
        return null
    }
    ...
    function vq(a, b) {
        ...
        oq(e, f, b);
        Zo(g => {
            Xc(zf(g), 6) || (g = zf(g), bd(g, 6))
        })
    }

    function xq(a, b) {
        jn(p).wasPlaTagProcessed = !0;
        const c = () => {
                vq(a, b)
            },
            d = p.document;
        if (d.body || d.readyState === "complete" || d.readyState === "interactive") vq(a, b);
        else {
    ...
    function Aq(a, b) {
        ...
        if (c) {
            ...
            if (d.head_tag_slot_vars) Bq(c);
                ...
                e.google_adbreak_test || b.i() ? .i() ? Cq(f, a) : Mp(() => {
                    Cq(f, a)
                })
            }
        }
    ...
    function Bq(a) {
        ...
        if ((a = Od(c, "client") || a.getAttribute("data-ad-client") || "") && a !== b.google_ad_client) throw new V("Warning: Do not add multiple property codes with AdSense tag to avoid seeing unexpected behavior. These codes were found on the page " + a + ", " + b.google_ad_client);
    }
    ...
    function yq(a, b, c, d) {
        ...
        Zo(f => {
            Xc(zf(f), 3) || (f = zf(f), bd(f, 3))
        });
        d.j() && Eq(a, d.g().g(), I(d, 2));
        var e = Dq(a);
        if (e !== 0)
            if (d = xm(), d.first_slotcar_request_processing_time || (d.first_slotcar_request_processing_time = Date.now(), d.adsbygoogle_execution_start_time = ua), jq == null) Fq(a), kq.push(a);
            else if (e === 3) {
            const f = jq;
            bk(787, () => {
                f.handleAdConfig(a)
            })
        } else dk(730, jq.handleAdBreak(a));
        else {
            ua = (new Date).getTime();
            Qn(c, d, wq(a));
            Gq();
            ...
            if (e) Zo(f => {
                ...
                e = (c = !!b.google_wrap_fullscreen_ad) ?
                    Iq() : Jq(a.element);
                c && (c = Lp(), b.google_ad_height = c.height, b.google_ad_width = c.width, b.fsapi = !0);
                Lo(e, b);
    ...
    function Eq(a, b, c) {
        Lq || (Lq = !0, a = wq(a) || xn(O), ck("predictive_abg", {
            a_c: a,
            p_c: b.join(),
            b_v: c
        }, .01))
    ...
    function Kq(a) {
        ke(() => {
            jn(p).wasPlaTagProcessed || p.adsbygoogle && p.adsbygoogle.push(a)
        })
    }
    ...
    function Jq(a) {
        if (a) {
            if (!nq(a) && (a.id ? a = rq(a.id) : a = null, !a)) throw new V("'element' has already been filled.");
            if (!("innerHTML" in a)) throw new V("'element' is not a good DOM element.");
        } else if (a = rq(), !a) throw new V("All 'ins' elements in the DOM with class=adsbygoogle already have ads in them.");
        return a
    }
    ...
    function Cq(a, b) {
        b = hn(2, p, b.Ib).Wa.then(c => {
            jq == null && (c.init(a), jq = c, Qq(c))
        });
        W.da(723, b);
        b.finally(() => {
            kq.length = 0;
    ...
    function Qq(a) {
        for (const [c, d] of lq) {
            var b = c;
            const e = d;
            e !== -1 && (p.clearTimeout(e), lq.delete(b))
        }
        for (b = 0; b < kq.length; b++) {
            if (lq.has(b)) continue;
            const c = kq[b],
                d = Dq(c);
            bk(723, () => {
    ...
    function Fq(a) {
        var b = kq.length;
        if (Dq(a) === 2 && a.type === "preroll" && a.adBreakDone != null) {
            var c = a.adBreakDone;
            mq === -1 && (mq = Date.now());
            var d = p.setTimeout(() => {
                try {
    ...
    (function(a, b, c, d = () => {}) {
        ...
        bk(166, () => {
            ...
            const k = c(h, f);
            h = O.document.currentScript === null ? 1 : hp(k.Kb);
            Em(g, f);
            Gp(g, f, h);
            Zo(m => {
                var n = Vc(m, 1) + 1;
                B(m, 1, Nb(n), 0);
                O.top === O && (n = Vc(m, 2) + 1, B(m, 2, Nb(n), 0));
                Xc(zf(m), 1) || (m = zf(m), bd(m, 1))
            });
            dk(1086, cp(h === 0));
            if (!Ja() || xa(Oa(), 11) >= 0) {
                ak(S(Fi));
        ...
        const c = Vc(b, 1) > 2012 ? `_fy${Vc(b,1)}` : "",
            d = I(b, 3);
        b = I(b, 2);
